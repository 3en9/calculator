...
def main():
    ...
    window.bind('1', lambda x: add('1'))
    window.bind('2', lambda x: add('2'))
    window.bind('3', lambda x: add('3'))
    window.bind('4', lambda x: add('4'))
    window.bind('5', lambda x: add('5'))
    window.bind('6', lambda x: add('6'))
    window.bind('7', lambda x: add('7'))
    window.bind('8', lambda x: add('8'))
    window.bind('9', lambda x: add('9'))
    window.bind('0', lambda x: add('0'))
    window.bind('(', lambda x: add('('))
    window.bind(')', lambda x: add(')'))
    window.bind('*', lambda x: add('*'))
    window.bind('+', lambda x: add('+'))
    window.bind('-', lambda x: add('-'))
    window.bind('/', lambda x: add('/'))
    window.bind('.', lambda x: add('.'))
    window.bind('<Delete>', lambda x: clear())
    window.bind('<BackSpace>', lambda x: erase())
    window.bind('<Return>', lambda x: calc())
    window.bind('=', lambda x: calc())
